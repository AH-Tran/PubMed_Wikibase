...
def upload_data():
    ...
    for index, row in mydata.iterrows():
        ...
        item_statements.append(wdi_core.WDString("column1_value", prop_nr="P11")) #title 
        item_statements.append(wdi_core.WDString("column1_value", prop_nr="P32")) #abstract 
        item_statements.append(wdi_core.WDString("column1_value", prop_nr="P12")) #author
        item_statements.append(wdi_core.WDString("column1_value", prop_nr="P5"))  #Pubmed ID
        item_statements.append(wdi_core.WDString("column1_value", prop_nr="P14")) #publication date
        item_statements.append(wdi_core.WDString("column1_value", prop_nr="P29")) #MeSH Descriptor ID
